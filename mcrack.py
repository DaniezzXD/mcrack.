...
br.addheaders = [('User-Agent', 'Mozilla/5.0 (SymbianOS/9.3; Series60/3.2 NokiaC5-00.2/101.003; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) NokiaBrowser/7.3.1.35 Mobile Safari/533.4 3gpp-gba')]
...
def ambil_link():
    ...
    print logo
    print 50* "─"
    jalan("anda akan dialihkan ke youtube jangan lupa subcribe")
...
def menu():
    ...
    try:
        ...
        os.system('clear')
        print"[!] Token yang anda masukkan mungkin salah/kadaluarsa"
        os.system('rm -rf login.txt')
        time.sleep(1)
        masuk()
        time.sleep(1)
